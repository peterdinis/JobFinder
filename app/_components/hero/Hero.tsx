                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <motion.div
                            ...
                            className="inline-block bg-blue-500 text-white px-4 py-2 rounded-full text-sm mb-6"
                        >
                        ...
                        <p className="text-xl text-blue-100 mb-8">
                            Connect with top companies worldwide and find the job that matches your expertise and aspirations.
                        </p>
                        <div className="bg-white rounded-full shadow-lg p-2 flex items-center mb-8">
                        ...
                        <div className="flex items-center space-x-4 text-blue-100">
                            <span>Popular:</span>
                            {['Remote', 'Full-time', 'Tech', 'Marketing'].map((tag, index) => (
                    ...
                    >
                        ...
                        <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-lg shadow-lg">
                            <div className="flex items-center space-x-2">
                                ...
                                <span className="text-gray-600 font-medium">1,234 people hired today</span>
                            </div>
                        </div>
                    </motion.div>
                </div>
