...
import { Code, Building2, Palette, ChartBar, Microscope, Globe, HeartHandshake, GraduationCap } from "lucide-react";
    ...
    return (
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Find opportunities in various industries</p>
          </motion.div>
