...
import { Company } from "@/app/_types/companyTypes"
...
export function CompanyCard({ company }: CompanyCardProps) {
  return (
    <Card className={`hover:shadow-lg transition-all ${company.featured ? "border-primary" : ""}`}>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 py-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">{company.stats.employees.toLocaleString()} employees</span>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="flex items-center justify-between pt-2">
            <p className="text-sm font-medium text-primary">{company.openPositions} open positions</p>
