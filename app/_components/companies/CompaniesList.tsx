...
import { Search, Briefcase, Building2, Trophy } from "lucide-react"
...
export default function CompaniesList() {
  ...
  const totalJobs = companies.reduce((acc, company) => acc + company.openPositions, 0)
  const totalCompanies = companies.length
  const averageRating = (companies.reduce((acc, company) => acc + company.stats.rating, 0) / companies.length).toFixed(
    1,
  )
