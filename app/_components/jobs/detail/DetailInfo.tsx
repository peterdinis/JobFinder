...
import { ArrowLeft, Briefcase, Building2, Clock, DollarSign, Globe2, MapPin } from "lucide-react";
    ...
    return (
        <div className="min-h-screen ">
            <div className="max-w-4xl mx-auto p-6">
                ...
                >
                    <Link href="/jobs">
                        <Button variant="ghost" className="gap-2 hover:translate-x-[-4px] transition-transform">
                    ...
                    <Card className="p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                        ...
                        >
                            <div>
                                ...
                                >
                                    {[
                                        { icon: <Briefcase className="h-3 w-3" />, text: jobData.type },
                                        { icon: <DollarSign className="h-3 w-3" />, text: jobData.salary },
                                        { icon: <Clock className="h-3 w-3" />, text: jobData.posted },
                                        { icon: <Globe2 className="h-3 w-3" />, text: jobData.experience }
                                    ].map((item, index) => (
                                        <motion.div
                                            key={index}
                                            variants={fadeIn}
